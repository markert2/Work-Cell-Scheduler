	...
	function testPersonApp() {
		...
		function testPersonWeb(){
			...
			$this->assertValidHTML('Web/person.php','Dr. Middelkoop',
				array('action'=>'Load','person'=>'DrMiddelkoop'),"unable to load from page");
			$this->assertValidHTML('Web/person.php','Dr. Timothy Middelkoop',
				array('action'=>'Update','person'=>'DrMiddelkoop','name'=>'Dr. Timothy Middelkoop'),"unable to save from page");
				}
	}		
